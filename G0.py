...
# Seleccionar los chunks y insertarlos en la tabla chunks_table_pgvector.
...
# Medición por lotes para sacar las métricas de inserción de los chunks en PostgreSQL con pgvector
batch_size = 1000
times = []
total = len(chunks)
...
for i in tqdm(range(0, total, batch_size)):
    ...
    execute_values(cursor,
        "INSERT INTO chunks_table_pgvector (chunk) VALUES %s",
        batch_chunks,
